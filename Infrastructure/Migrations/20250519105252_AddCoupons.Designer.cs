...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250519105252_AddCoupons")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CouponService", b =>
                {
                    ...
                    b.HasKey("CouponsId", "ServicesId");

                    b.HasIndex("ServicesId");

                    b.ToTable("CouponService");
                });
            ...
            modelBuilder.Entity("Domain.Entities.RecordMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RecordMessages", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.RecordStatusLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RecordStatusLog", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Coupon", b =>
                {
                    ...
                    b.OwnsOne("Domain.ValueObjects.CouponUsageLimit", "UsageLimit", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.Record", b =>
                {
                    ...
                    b.OwnsOne("Domain.ValueObjects.RecordReview", "Review", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.Staff", b =>
                {
                    ...
                    b.OwnsOne("Domain.ValueObjects.StaffSettings", "Settings", b1 =>
                        {
