...
public class AddTimeSlotDto : IMapWith<AddTimeSlotCommand>
{
    [SwaggerIgnore]
    ...
    public List<AddIntervalsDto> Intervals { get; set; } = [];

    public void Mapping(Profile profile)
    {
        profile.CreateMap<AddTimeSlotDto, AddTimeSlotCommand>()
